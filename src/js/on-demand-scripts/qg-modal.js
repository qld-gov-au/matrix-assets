      ...
      .on("show.bs.modal", function (event) {
        ...
        if (button.hasClass("image-modal")) {
          ...
          modal
            ...
            .prepend('<div class="modal-header">' + close + "</div>");
        ...
        $.ajax({
          ...
          success: function success(data) {
            modal
              .find(".modal-content")
              .html('<div class="modal-body">' + data + "</div>"); // If the url targets a specific element, replace modal content with only that element
