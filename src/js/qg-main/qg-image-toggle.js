...
$(function () {
  ...
  $(".figure-credits", figureElement).each(function () {
    $(this)
      ...
      .before(
        '<button class="figure-credits-toggle" title="View credits"><img src="/__data/assets/git_bridge/0013/139/images/content-types/icon-image-credit.png" alt="View credits" /></button>'
      )
      // hide the credits
      .hide();
  });
