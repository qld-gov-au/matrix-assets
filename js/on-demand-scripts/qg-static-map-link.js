...
<img src="" data-lat="-24.863789" data-long="152.354064 data-zoom="11">
*/
function generateStaticMapImg(ele) {
    var lat = ele.attr('data-lat') || -27.4673,
        ...
        return 'https://maps.googleapis.com/maps/api/staticmap?size=373x189&maptype=roadmap&markers=' + lat +'%2C'+ lon +'&key=' + googleApiKey + '&sensor=false&zoom=' + zoom;
}