...
//   var isProd = function () {
//     return (
//       window.location.hostname.search(/dev|test|localhost|github|\buat\b/) ===
//       -1
//     );
//   };
//   // lazy load a script
...
//       ? keys.defGoogle.uat
//       : keys.defGoogle.prod;
//   window.qg.googleRecaptchaApiKey =
//     window.location.hostname.search(
//       /\bdev\b|\btest\b|\blocalhost\b|\buat\b/
//     ) !== -1
...
//   }
//   googleApiKey =
//     window.qg.franchise && window.qg.franchise.apiKey
//       ? window.qg.franchise.apiKey
//       : window.qg.googleKey;
...
//       console.log('matrix google api is loaded');
//       var s = document.createElement('script'),
//         u =
//           'https://maps.googleapis.com/maps/api/js?key=' +
//           googleApiKey +
//           '&region=AU&libraries=places';
