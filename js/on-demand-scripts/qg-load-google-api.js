...
// 	In order to fix this problem, it would be best to make Maps component as a SPA completely in SWE, so that it would not be dependent on Matrix assets and content templates.
